  ...
  try {
    ...
    switch (accion) {
      ...
      case "rechazar_linkapsis":
        await CanchaService.validarLinkapsis(canchaId, false, observaciones, void 0, false, usuario);
        break;
      ...
      case "rechazar_llay_llay":
        await CanchaService.validarLlayLlay(canchaId, false, observaciones, void 0, false, usuario);
        break;
      case "cerrar_cancha":
